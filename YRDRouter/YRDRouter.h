 ...
 */
typedef void (^YRDRouterHandler)(NSDictionary *routerParameters);

/**
 *  需要返回一个 object，配合 objectForURL: 使用
 */
typedef id (^YRDRouterObjectHandler)(NSDictionary *routerParameters);
 ...
 *  [YRDRouter generateURLWithPattern:MGJ_ROUTE_BEAUTY, @[@13]];
 *
 *
